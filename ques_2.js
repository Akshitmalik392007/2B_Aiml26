// Q2. 2. Bank Account Management System
...
class BankAccount {
   constructor(accountNo,holderName,balance){
    ...
    static bankInfo() {
        console.log("Bank Name: Malik Bank");
...
console.log("\n--- Account 1 ---");
let account1 = new BankAccount("1001", "Rahul Sharma", 10000);
...
let account2 = new BankAccount("1002", "Ayush Sharma", 8000);
